...
const urlBaseAutenticacion = 'http://127.0.0.1:5000'; // micro auth
const urlBaseEmpresa = 'http://127.0.0.1:8082/'; //micro Gestion empresa
const urlBaseEquipos = 'http://127.0.0.1:3000/'; //micro Gestion equipos
const urlBaseCandidatos = 'http://127.0.0.1:4000/'; //micro Gestion equipos
